            ...
            <div className="container mx-auto px-4">
                ...
                <section className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-24">
                    <div className="relative w-full">
                        <div className="aspect-[4/5] relative rounded-2xl overflow-hidden shadow-2xl mb-6">
                            <Image
                        ...
                        <div className="flex justify-center gap-6">
                            <Link href="https://blog.naver.com/ultramsw67" target="_blank" className="text-sood-burgundy font-bold hover:underline">Naver Blog</Link>
                            <Link href="https://brunch.co.kr/@a3b90b2e717a467" target="_blank" className="text-sood-burgundy font-bold hover:underline">Brunch</Link>
                            <Link href="https://www.linkedin.com/in/%EC%84%B1%EC%9A%B4-%EB%AC%B8-415976234/" target="_blank" className="text-sood-burgundy font-bold hover:underline">LinkedIn</Link>
                        </div>
                    </div>
