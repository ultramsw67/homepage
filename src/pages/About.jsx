      ...
      <section className="section prose-section">
        ...
        <div className="prose">
          ...
          <p>
            ...
            19년 동안 투자를 유치해 회사를 키웠고, 사업 매각(Exit)으로 결실을 맺었습니다.
          </p>
          <p>
            2023년부터는 25만 유저 서비스의 전략 고문으로 유저 세그멘테이션과 리텐션을 관리하고, AI 에이전트 도입 모델과 신사업 타당성을 검토했습니다.
            지금은 대기업의 '구조적 사고'와 창업가의 '실전 감각'을 합쳐 초기 창업자와 1:1로 일합니다. 지금까지 20개 팀의 사업모델, 지표, 투자·정부지원을 자문했습니다.
          </p>
          <p>
