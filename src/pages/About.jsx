    ...
    <div className="wrap page">
      ...
      <section className="section prose-section">
        ...
        <div className="prose" style={{ marginTop: 28 }}>
          ...
          <p>
            2023년부터는 25만 유저 서비스의 전략 고문으로 유저 세그멘테이션과 리텐션을 맡고 AI 에이전트 도입 모델과 신사업 타당성을 검토했습니다.
            지금은 대기업의 구조적 사고와 창업가의 실전 감각을 합쳐 초기 창업자와 1:1로 일합니다. 그동안 스무 팀의 사업모델, 지표, 투자·정부지원을 함께 풀었습니다.
          </p>
          <p>
            매일 아침 네이버 블로그 「Design &amp; Breakthrough」에 스타트업 경영 칼럼을 쓰고, 브런치북 「온라인 쇼핑몰의 데이터 경영 전략」 「런웨이 12주, 1000억의 증명」을 펴냈으며,
