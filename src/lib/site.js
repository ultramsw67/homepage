...
export const experience = [
  {
    period: '2025.12 —', org: '수트와후드 (SOOD)', role: '스타트업 경영 컨설턴트',
    desc: '초기 창업자와 스타트업을 위한 1:1 자문과 멘토링. 네이버 블로그 「Design & Breakthrough」, 브런치, 모비인사이드에 스타트업 경영 칼럼 연재.',
    points: [
      '초기 창업자 및 스타트업 대상 비즈니스 모델(BM), 사업계획서, MVP/PMF 검증 전략 정밀 자문 및 멘토링',
      '브런치북 「온라인 쇼핑몰의 데이터 경영 전략」, 「런웨이 12주, 1000억의 증명」 발행',
    ],
  },
  {
    period: '2023.12 — 2025.11', org: '더문테크', role: '전략 고문',
    desc: '25만 유저 서비스의 데이터 경영과 스케일업 전략을 맡았습니다.',
    points: [
      '25만 유저 대상 유저 세그멘테이션 수립, 온보딩부터 충성 고객 전환까지의 스케일업 전략 빌딩',
      '주간 단위 UX 데이터 분석을 통한 리텐션(Retention) 관리와 타깃 유저 패턴 분석',
      '경쟁사 분석 및 AI Agent 비즈니스 도입 모델 수립, 신규 사업 타당성 정밀 시뮬레이션',
      'Google Analytics 데이터 분석 실무 리드, 전사 기업 데이터 관리(Company Data Management) 교육 진행',
    ],
  },
