...
export const services = [
  {
    ...
    outputs: ['비즈니스 모델 진단', '사업 타당성 시뮬레이션', '유닛 이코노믹스 · 13주 현금흐름', 'Exit 및 M&A'],
  },
  {
    id: 'growth',
    number: '02',
  ...
  },
  {
    ...
    description: '예비창업패키지, 프리팁스·TIPS, 정책자금, 공공조달 첫 고객까지 우리 회사에 맞는 지원사업 지도를 한 장으로 만들고 심사위원과 투자자가 실제로 보는 기준으로 계획서와 피칭을 다시 씁니다. 1차 탈락 피드백으로 2차에 붙는 것까지가 범위입니다.',
  ...
  },
  {
    ...
    number: '04',
    title: 'AI 에이전트 · 1인 기업',
    tagline: '운영 체계와 사업모델을 함께 설계합니다.',
    description: 'AI 에이전트를 팀원처럼 두는 1인 기업의 운영 체계를 만듭니다. 무엇을 자동화하고 무엇을 사람이 맡을지 정한 뒤 그 체계로 돌아가는 비즈니스 모델을 수익 구조까지 한 장으로 그립니다. 제가 매일 쓰는 리서치·초안·분석 워크플로를 그대로 보여드립니다.',
    outputs: ['1인 기업 AI 운영 체계 설계', 'AI 기반 비즈니스 모델 · 수익 구조 설계', '자동화 우선순위 · 도구 지도'],
  },
];
